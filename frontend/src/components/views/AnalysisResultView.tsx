...
import { Heart, ArrowRight, Sparkles, RefreshCcw } from "lucide-react";
...
export function AnalysisResultView({
  ...
  const getStressColor = () => {
    if (stressLevel < 40) return "from-mint to-mint/70";
    if (stressLevel < 70) return "from-peach to-peach/70";
    return "from-rose to-rose/70";
  };
        ...
        <div className="bg-card rounded-3xl p-8 lg:p-12 shadow-elevated border border-border/50 text-center">
          ...
          <div className="relative w-40 h-40 lg:w-52 lg:h-52 mx-auto mb-6 lg:mb-8">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              <span className="text-4xl lg:text-5xl mb-1">{getStressEmoji()}</span>
          ...
          <p className="text-muted-foreground lg:text-lg mb-6 lg:mb-8">{message}</p>
          ...
          <div className="bg-muted/50 rounded-xl p-4 text-left">
            ...
            <p className="text-sm text-muted-foreground">
              {stressLevel < 40
                ...
                : "Te recomendamos buscar un lugar tranquilo y practicar la técnica de respiración 4-7-8."}
            </p>
          </div>
        </div>
